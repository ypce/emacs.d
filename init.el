...
(keymap-global-set "C-c t" #'vp/tts-speak-dwim)   ; terminal frames get no super keys
(keymap-global-set "s-'" #'vp/tts-speak-dwim)     ; GUI frames
(keymap-global-set "C-c +" #'vp/tts-speed-up)
(keymap-global-set "C-c -" #'vp/tts-speed-down)
